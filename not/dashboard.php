<?php
// dashboard.php - No changes to design, content emptied for pre-login state
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>Lena Gym Bocaue - Dashboard</title>
    ...
    <style>
        ...
        .sidebar h1 {
            color: rgb(var(--text-rgb)); /* Changed to white */
        ...
        @media (max-width: 768px) {
            ...
            .activity-item .text-right span {
                padding: 0.25rem 0.75rem;
                font-size: 0.75rem;
                transition: all 0.3s ease;
            }
            .activity-item .text-right span:hover {
                transform: scale(1.1);
...
<body>
    ...
    <aside id="admin-sidebar" class="sidebar fixed inset-y-0 left-0 z-50 p-4 overflow-y-auto md:block hidden admin-only">
        ...
        <nav class="space-y-1">
            <a href="dashboard.php" class="flex items-center gap-3 rounded-lg active">
    ...
    <aside id="customer-sidebar" class="sidebar fixed inset-y-0 left-0 z-50 p-4 overflow-y-auto md:block hidden customer-only">
        ...
        <nav class="space-y-2">
            <a href="dashboard.php" class="flex items-center gap-3 p-3 rounded-lg active">
            ...
            <a href="#" class="flex items-center gap-3 p-3 rounded-lg" onclick="if(confirm('Are you sure you want to logout?')) { localStorage.clear(); window.location.href = 'index.php'; }">
                <span class="material-symbols-outlined text-2xl">logout</span>
                <span>Logout</span>
            </a>
        </nav>
        <div class="mt-8 pt-8 border-t border-text-muted/30 space-y-2">
            <a href="profile.php" class="flex items-center gap-3 p-3 rounded-lg">
    ...
    <main id="admin-main" class="main-content min-h-screen p-6 admin-only">
        ...
        <header class="top-bar flex items-center justify-between mb-8">
            ...
            <div class="top-bar-right flex items-center gap-4 relative">
                ...
                <div class="search-container relative md:w-64">
                    ...
                    <input type="text" placeholder="Search members..." class="search-input pl-10 pr-4 py-2 bg-card rounded-full text-sm w-full" onkeyup="searchMembers(this.value)">
                </div>
                <div class="top-bar-buttons flex items-center gap-2">
                    <button class="bg-primary px-4 py-2 rounded-full font-medium flex items-center gap-2 shadow-neon" onclick="addNewMember()">
        ...
        <section class="welcome-hero">
            <h2 class="text-3xl font-bold mb-2" id="admin-welcome-name">Welcome back, Admin!</h2>
            <p class="text-text-muted mb-4">Manage your gym operations and keep everything running smoothly.</p>
            <button class="bg-primary px-6 py-3 rounded-full font-bold text-sm hover:bg-red-600 transition-colors shadow-neon" onclick="quickOverview()">
                Quick Overview
            </button>
        </section>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2">
                <div class="card p-6 mb-6">
                    <div class="flex items-center justify-between mb-6">
                        ...
                        <a href="#" class="text-primary text-sm font-medium" onclick="viewAllActivities()">See All</a>
                    </div>
                    <div class="space-y-4">
                        <div class="p-4 text-text-muted text-sm">No recent activity yet.</div>
                    </div>
                </div>
            </div>
            ...
            <div>
                <div class="card p-6 mb-6">
                    ...
                    <div class="space-y-4">
                        <div class="bg-accent p-4 rounded-lg">
                            <p class="text-xs text-text-muted mb-1">Total</p>
                        ...
                        <div class="bg-accent p-4 rounded-lg">
                            <p class="text-xs text-text-muted mb-1">New</p>
                            <p class="font-bold text-primary">0</p>
                        </div>
                        <div class="bg-accent p-4 rounded-lg">
                            <p class="text-xs text-text-muted mb-1">Renewals</p>
                ...
                <div class="card p-6">
                    <div class="flex items-center justify-between mb-6">
                        <h2 class="text-xl font-bold">Gym Usage</h2>
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <p class="text-xs text-text-muted mt-1">0% of capacity</p>
                        </div>
                        <div>
                            <p class="text-sm text-text-muted mb-2">Peak Hours</p>
                            <div class="progress-bar">
                                <div class="progress-fill" style="width: 0%;"></div>
                            </div>
                            <p class="text-xs text-text-muted mt-1">No data</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="card p-6 mt-6">
            ...
            <div class="quick-actions-grid grid grid-cols-1 md:grid-cols-3 gap-4">
                <a href="user.php" class="flex items-center gap-3 p-4 bg-accent rounded-lg hover:bg-primary/10 transition-colors">
                    <div class="w-12 h-12 bg-primary rounded-full flex items-center justify-center">
                        <span class="material-symbols-outlined text-white">groups</span>
                    </div>
                    <div>
                        <p class="font-medium">User Management</p>
                        <p class="text-xs text-text-muted">Manage profiles</p>
                    </div>
                </a>
                <a href="booking.php" class="flex items-center gap-3 p-4 bg-accent rounded-lg hover:bg-primary/10 transition-colors">
                    ...
                    <div>
                        <p class="font-medium">Service Booking</p>
                        <p class="text-xs text-text-muted">Calendar</p>
                    </div>
                </a>
                <a href="billing.php" class="flex items-center gap-3 p-4 bg-accent rounded-lg hover:bg-primary/10 transition-colors">
                    <div class="w-12 h-12 bg-warning rounded-full flex items-center justify-center">
                        <span class="material-symbols-outlined text-white">payment</span>
                    </div>
                    <div>
                        <p class="font-medium">Transaction</p>
                        <p class="text-xs text-text-muted">Billing</p>
                    </div>
                </a>
                <a href="reports.php" class="flex items-center gap-3 p-4 bg-accent rounded-lg hover:bg-primary/10 transition-colors">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-text-muted">Analytics</p>
                    </div>
                </a>
            </div>
        </div>
    ...
    <main id="customer-main" class="main-content min-h-screen p-6 customer-only">
        ...
        <header class="top-bar flex items-center justify-between mb-8">
            ...
            <div class="top-bar-right flex items-center gap-4 relative">
                ...
                <div class="search-container relative md:w-64">
                    <span class="material-symbols-outlined absolute left-3 top-1/2 transform -translate-y-1/2 text-text-muted">search</span>
                    <input type="text" placeholder="Search classes..." class="search-input pl-10 pr-4 py-2 bg-card rounded-full text-sm w-full" onkeyup="searchClasses(this.value)">
                </div>
                <div class="top-bar-buttons flex items-center gap-2">
                    <button class="bg-primary rounded-full font-medium flex items-center gap-1 shadow-neon md:px-4 md:py-2 md:text-sm md:gap-2" onclick="bookClass()">
                        <span class="material-symbols-outlined">add</span>
        ...
        <section class="welcome-hero">
            <h2 class="text-3xl font-bold mb-2" id="customer-welcome-name">Welcome back, John!</h2>
            <p class="text-text-muted mb-4">Ready to crush your fitness goals today? Let's get started.</p>
            <button class="bg-primary px-6 py-3 rounded-full font-bold text-sm hover:bg-red-600 transition-colors" onclick="startWorkout()">
                Start Workout
            </button>
        </section>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <!-- Upcoming Schedule Customer -->
            <div class="lg:col-span-2">
                <div class="card p-6 mb-6">
                    <div class="flex items-center justify-between mb-6">
                        <h2 class="text-xl font-bold">Upcoming Schedule</h2>
                        <a href="booking.php" class="text-primary text-sm font-medium">View All</a>
                    </div>
                    <div class="space-y-4">
                        <div class="p-4 text-text-muted text-sm">No upcoming schedule yet.</div>
                    </div>
                </div>
            </div>

            <!-- Membership Status Customer -->
            <div>
                <div class="card p-6 mb-6">
                    <div class="flex items-center justify-between mb-6">
                        <h2 class="text-xl font-bold">Membership</h2>
                        <a href="billing.php" class="text-primary text-sm font-medium">Manage</a>
                    </div>
                    <div class="space-y-4">
                        <div class="bg-accent p-4 rounded-lg">
                            <p class="text-xs text-text-muted mb-1">Plan</p>
                            <p class="font-bold text-primary">-</p>
                        </div>
                        <div class="bg-accent p-4 rounded-lg">
                            <p class="text-xs text-text-muted mb-1">Expires</p>
                            <p class="font-bold text-warning">-</p>
                        </div>
                        <div class="bg-accent p-4 rounded-lg">
                            <p class="text-xs text-text-muted mb-1">Visits Left</p>
                ...
                <div class="card p-6">
                    <div class="flex items-center justify-between mb-6">
                        ...
                        <a href="#" class="text-primary text-sm font-medium" onclick="viewProgressReport()">View Report</a>
                    </div>
                    <div class="space-y-4">
                        <div>
                            <p class="text-sm text-text-muted mb-2">Weight Goal</p>
                            <div class="progress-bar">
                                <div class="progress-fill" style="width: 0%;"></div>
                            </div>
                            <p class="text-xs text-text-muted mt-1">No data</p>
                        ...
                        <div>
                            <p class="text-sm text-text-muted mb-2">Sessions Completed</p>
                            <div class="progress-bar">
                                <div class="progress-fill" style="width: 0%;"></div>
                            </div>
                            <p class="text-xs text-text-muted mt-1">No data</p>
        ...
        <div class="card p-6 mt-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <a href="booking.php" class="flex items-center gap-3 p-4 bg-accent rounded-lg hover:bg-primary/10 transition-colors">
                    ...
                    <div>
                        <p class="font-medium">Service Booking</p>
                        <p class="text-xs text-text-muted">Book & Calendar</p>
                    </div>
                </a>
                <a href="billing.php" class="flex items-center gap-3 p-4 bg-accent rounded-lg hover:bg-primary/10 transition-colors">
                    <div class="w-12 h-12 bg-warning rounded-full flex items-center justify-center">
    ...
    <script>
        // Determine role from localStorage (set this after login, e.g., localStorage.setItem('role', 'admin') or 'customer')
        const role = localStorage.getItem('role') || 'customer'; // Default to customer
        const userName = localStorage.getItem('userName') || (role === 'admin' ? 'Lena Admin' : 'John Doe');
        ...
        function updateUserInfo() {
            ...
            if (adminWelcome) adminWelcome.textContent = `Welcome back, ${userName}!`;
            ...
            if (customerWelcome) customerWelcome.textContent = `Welcome back, ${userName}!`;
        ...
        function addNewMember() {
            alert('Adding new member... Redirecting to user management.');
            window.location.href = 'user.php';
        }

        function quickOverview() {
            alert('Quick overview displayed! Showing summary stats.');
        }

        function viewAllActivities() {
            alert('Viewing all recent activities...');
        }

        function searchMembers(query) {
            alert('Searching for members: ' + query);
        }

        // Customer functions
        function bookClass() {
            alert('Booking a class... Redirecting to booking page.');
            window.location.href = 'booking.php';
        }

        function startWorkout() {
            alert('Starting workout session! Timer initiated.');
        }

        function searchClasses(query) {
            alert('Searching for classes: ' + query);
        }

        function viewProgressReport() {
            alert('Progress report viewed! Generating PDF.');
        }
        ...
        // Auto-close sidebar on mobile after clicking any link
